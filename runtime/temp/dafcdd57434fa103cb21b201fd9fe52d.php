<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\xampp\htdocs\TMES\public/../app/home\view\tpso\edit.html";i:1540886910;}*/ ?>
	...
	<div data-options="region:'north',border:false,split:false"> 
		<form id="__MODULE__EdtForm" method="post" >
			<table id="__MODULE__Head" class="tableForm" style="white-space: nowrap;width:100%">
				<tr>
					<td><label><?php echo \think\Lang::get('LANG_SO_NO'); ?></label></td>
					...
					<td><label><?php echo \think\Lang::get('LANG_SO_TARGET_QTY'); ?></label></td>
				...
				<tr>
					<td><label><?php echo \think\Lang::get('LANG_SO_FREIGHT_DESC'); ?></label></td>
					<td>
	...
	<div data-options="region:'center',border:false"> 
		<table id="__MODULE__AddDataGrid" class="easyui-datagrid"
				data-options="singleSelect:true,idField:'id', checkOnSelect : true, selectOnCheck : true, 
							...
							border:false,
							pageSize :20,
							url:'<?php echo url('XxGetDetailData'); ?>',
							queryParams:{ so_number : '<?php echo \think\Request::instance()->request('so_number'); ?>',so_type : '<?php echo \think\Request::instance()->request('so_type'); ?>' },
			...
			<thead>
				<tr>
					...
					<th data-options="field:'dept1_desc',align:'center',width:65"><?php echo \think\Lang::get('LANG_SO_DEPT1_DESC'); ?></th>
					<th data-options="field:'freight_desc',align:'center',width:150"><?php echo \think\Lang::get('LANG_SO_FREIGHT_DESC'); ?></th>
					<th data-options="field:'pin_desc',align:'center',width:150"><?php echo \think\Lang::get('LANG_SO_PIN_DESC'); ?></th>
...
function __MODULE__AddItemFun() {
		...
		$('<div/>').dialog({
			href : '/home/tpso/XxwkItem?grid=__MODULE__AddDataGrid',
			resizable:true,
			width : 500,
			height :450, 
			modal : true,
