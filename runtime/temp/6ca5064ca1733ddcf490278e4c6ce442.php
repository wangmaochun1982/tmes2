<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\xampp\htdocs\TMES\public/../app/home\view\Tcmtmodel\index.html";i:1540797969;}*/ ?>
...
<script type="text/javascript">
		...
		__MODULE__FilterDG.datagrid('enableFilter',[{field:'model_name',
									...
									{field:'unit',
									 type:'text'
										...
										options:{
											panelHeight:'auto',
											url: '/home/tcmtmodel/x_xgetOption?cusCode=model_type1&filter=1',
											valueField:'id',
											textField:'text',
										...
										options:{
											panelHeight:'auto',
											url: '/home/tcmtmodel/x_xgetOption?cusCode=m_status&filter=1',
											valueField:'id',
											textField:'text',
											onChange:function(value){
												if (value == ''){
										...
										options:{
											panelHeight:'auto',
											url: '/home/tcmtmodel/x_xgetOption?cusCode=r_type&filter=1',
											valueField:'id',
											textField:'text',
											onChange:function(value){
												if (value == ''){
    ...
    function __MODULE__AddFun() {
	 ...
	 function __MODULE__UploadFileFun() {
		...
		$('<div/>').dialog({
			href : '/home/tcmtmodel/uploadFile?model_name='+modelName,
			width : 520,
			height : 360,
			modal : true,
				...
				handler : function() {
					...
					if (vTitle == "<?php echo \think\Lang::get('LANG_MODEL_UPTITLE'); ?>") {
						$('#__MODULE__updbmForm').form('submit', {
							url : '/home/tcmtmodel/x_xUploadDo',
							success : function(result) {
								try {
									var r = $.parseJSON(result);
									if (r.status==1) {
	...
	function __MODULE__ExportDataFun(){
		...
		location.href="/home/tcmtmodel/x_xexportData?"+timestamp;
	}
</script>